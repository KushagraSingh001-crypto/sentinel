...
contract ThreatChain {
     ...
     * @param threatId Unique identifier from MongoDB
     ...
     * @param threatId MongoDB threat identifier
    ...
    /**
     * @dev Retrieves a threat by its MongoDB ID
     * @param _threatId MongoDB threat identifier
